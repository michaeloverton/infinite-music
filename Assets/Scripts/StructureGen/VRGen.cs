...
public class VRGen : MonoBehaviour
{
    ...
    void Awake() {
        ...
        // If we can't find it, just set complexity/copies to default value.
        ...
        copies = structureComplexity.getCopies();
    }
    ...
    void Start()
    {
        ...
        for(int i=1; i <= copies; i++) {            
            GameObject one = Instantiate(primaryStructure, new Vector3(copyDistance*i, Random.Range(-200, 200), Random.Range(copyDistance*(i-1), copyDistance*i)), Quaternion.Euler(0, Random.Range(0,360), 0));
            GameObject two = Instantiate(primaryStructure, new Vector3(Random.Range(copyDistance*(i-1), copyDistance*i), Random.Range(-200, 200), copyDistance*i), Quaternion.Euler(0, Random.Range(0,360), 0));
            GameObject three = Instantiate(primaryStructure, new Vector3(-1*copyDistance*i, Random.Range(-200, 200), -1 * Random.Range(copyDistance*(i-1), copyDistance*i)), Quaternion.Euler(0, Random.Range(0,360), 0));
            GameObject four = Instantiate(primaryStructure, new Vector3(-1 * Random.Range(copyDistance*(i-1), copyDistance*i), Random.Range(-200, 200), -1*copyDistance*i), Quaternion.Euler(0, Random.Range(0,360), 0));
        }
